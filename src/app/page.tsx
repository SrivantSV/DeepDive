                  ...
                  <div className="pr-3 flex items-center gap-2">
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        e.preventDefault()
                        if (searchQuery.trim()) {
                          router.push(`/investor-check?q=${encodeURIComponent(searchQuery)}`)
                        }
                      }}
                      className="px-6 py-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold rounded-xl hover:from-emerald-600 hover:to-teal-700 transition-all duration-200 shadow-lg shadow-emerald-500/25 flex items-center gap-2"
                      title="Analyze investment potential"
                    >
                      <span className="hidden sm:inline">Investor Check</span>
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                      </svg>
                    </button>
